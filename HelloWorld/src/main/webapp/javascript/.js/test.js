...
let cloneObj = originObj; // originObj 참조값을 cloneObj. 주소값도 같다.

cloneObj.sname = 'Choi';
console.log(originObj.sname);
originObj.changeAge();
console.log(originObj.age);
...
console.log(s1);
console.log(s1.friend[0].name);
console.log(s1.friend[1].hobbies[0]); // 명식이의 첫번쨰 취미
