...
public class MemberListServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      // [{"memberId" : "user1", "memberPw : 1234" , "memberName: 홍길동", "memberRole :
      // 1"
      String json = "[";
...
//         json += "{\"memberId\" : \"" + list.get(i).getMemberId() + "\", \"memberPw " : \"" , \"memberName\": \""
//               + list.get(i).getMemberName() + "\", \"memberRole\" : " + list.get(i).getMemberName() + "}";
         if (i != list.size() - 1) {
            json += ",";
         }
      }
